    ...
    <Card className="border border-border rounded-2xl shadow-soft">
      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center p-4 rounded-xl border border-border bg-teal/10">
            <div className="text-3xl font-bold text-teal">
              ✓ {summary.passedTests}
            </div>
            <div className="text-sm text-muted-foreground mt-1">Passing</div>
          </div>
          <div className="text-center p-4 rounded-xl border border-border bg-destructive/10">
            <div className="text-3xl font-bold text-destructive">
              ✗ {summary.failedTests}
            </div>
            <div className="text-sm text-muted-foreground mt-1">Failing</div>
          </div>
          <div className="text-center p-4 rounded-xl border border-border bg-gold/10">
