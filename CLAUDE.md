...
│   └── sessions.ts  # Delete a conversation and its messages. RLS scopes both deletes to the
├── supabase/
...
| `lib/applications/sessions.ts` | Delete a conversation and its messages. RLS scopes both deletes to the | `deleteSession` |
